...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach((Element) => {
    const raisedToTheThirdNumber = Math.pow(Element, 3);
    arrayNumber.push(raisedToTheThirdNumber);
...
const addOne = (arr) => {
  ...
  const arrayNumber = [];
  arr.map((Element) => {
    const addNumber = Element + 1;
    arrayNumber.push(addNumber);
...
const addQuestion = (arr) => {
  // Solution code here...
  const arrayaddQuestionMark = [];
  arr.map((Element) => {
    const addQuestionMark = Element + '?';
    arrayaddQuestionMark.push(addQuestionMark);

  })
  return arrayaddQuestionMark;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    const powerNumber = Math.pow(2, arr[i]);
    arrayLoop.push(powerNumber);
  }
...
const forEachTwoToThe = (arr) => {
  ...
  const arraypow = [];
  arr.forEach((Element) => {
    const powerNumber = Math.pow(2, Element);
    arraypow.push(powerNumber);
