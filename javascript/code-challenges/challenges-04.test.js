...
const sortNumbers = (arr) => {
  // Solution code here...
  // a-b from the sort lecture

  return arr.sort((number1,number2) => {return (number1-number2)});
...
const sortBackwards = (arr) => {
  // Solution code here...
  return arr.sort((number1,number2) => {return (number2-number1)});
...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort((number1,number2) => {return (number1.price-number2.price)});
};
